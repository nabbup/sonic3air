...
public:
	...
	struct Setting
	{
		enum Type		// Hold in sync with script (except for the INVALID entry)
		{
			...
			SETTING_CLASSIC_TRANSPARENCY		= 0x80400b00,
			SETTING_GAME_BRANDING				= 0x80400c00,
			SETTING_NEW_SOUND_CUES				= 0x80400d00,
			SETTING_INSTA_SHIELD_STYLE			= 0x00400e01,
			SETTING_TITLE_SCREEN_MENU_OPTIONS	= 0x80400f00,
			SETTING_DISCORD_RPC_DETAILS			= 0x80401000,
			SETTING_HYPER_FLASH					= 0x80401101
		};
